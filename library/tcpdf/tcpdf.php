	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			if ($this->getRTL()) {
				...
				$header_x = (float)$this->original_lMargin + ((float)$headerdata['logo_width'] * 1.1);
			}
			$cw = (float)$this->w - (float)$this->original_lMargin - (float)$this->original_rMargin - ((float)$headerdata['logo_width'] * 1.1);
